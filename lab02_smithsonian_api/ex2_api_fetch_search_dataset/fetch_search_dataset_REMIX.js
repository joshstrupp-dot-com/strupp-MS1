function generateSmithsonianQuery(api_key, rows = 100, sort = 'relevancy', search_term = null, params = {}) {
    /**
...
const params = {
    // "unit_code": "NMNHM*",       // Unit code for museum
    // "object_type": "Books", // Type of object
    // "date": "19*",            // Date in normalized form
    // "language": "",     // Language from the vocabulary list
...
const queryUrl = generateSmithsonianQuery(api_key, 250, 'relevancy', 'skull', params);
